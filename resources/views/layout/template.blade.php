              ...
              <div class="col-md-9">
                <form id="form">
                  ...
                  <div class="form-group row">
                    <label for="exampleInputEmail1" class="col-md-2">provinsi</label>
                    <div class="col-md-3">
                      <select class="select2 form-control" name="provinsi" data-id="provinsi" id="provinsi" onChange="cari_kab(this.value);">
                        ...
                        ->get();$prov='';
                        foreach($provinsi as $fas){?>
                          <option value="{{$fas->prov_id}}" <?php if($fas->prov_id==$prov){?> selected<?php }?> >{{$fas->prov_id}} | {{$fas->prov_name}}</option>
                        <?php } ?>
                      </select>
                    </div>
                  </div>
                  <div class="form-group row">
                      <label for="tempat_lahir" class="col-md-2">Kabupaten</label>
                      <label class="col-md-3">
                          <select class="select2 form-control" name="kabupaten" data-id="kabupaten" id="kab" onChange="cari_kec(this.value);">
